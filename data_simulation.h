...
void data_simulation(double ref_freq, double *wavenumbers,
                     double *spec, double channel_bandwidth_hz, int time_acc, unsigned int num_channels,
...
void sky_model(int rank, double ref_freq, double *wavenumbers, double *spec,
